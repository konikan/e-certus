...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
	$path_dir = '../../../../uploads/text_images/';
	if(!is_dir($path_dir))
	{
		die("Brak dostępu do katalogu !");
	}
	define('CONFIG_SYS_DEFAULT_PATH', $path_dir); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', $path_dir);	//accept relative path only
