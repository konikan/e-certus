...
/**
 * OrderShippingRecipient filter form base class.
 *
 * @package    e-certus
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseOrderShippingRecipientFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('order_shipping_recipient_filters[%s]');
