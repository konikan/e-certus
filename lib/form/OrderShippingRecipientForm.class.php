...
/**
 * OrderShippingRecipient form.
 *
 * @package    e-certus
 * @subpackage form
 * @author     Your name here
 */
class OrderShippingRecipientForm extends BaseOrderShippingRecipientForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['company_name'] = new sfWidgetFormInputHidden();
       ...
       $this->widgetSchema['company_nip'] = new sfWidgetFormInputHidden();
