...
/**
 * UserRecipient form base class.
 *
 * @method UserRecipient getObject() Returns the current form's model object
 *
 * @package    e-certus
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseUserRecipientForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_recipient[%s]');
