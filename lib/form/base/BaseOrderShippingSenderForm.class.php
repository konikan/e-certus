...
/**
 * OrderShippingSender form base class.
 *
 * @method OrderShippingSender getObject() Returns the current form's model object
 *
 * @package    e-certus
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOrderShippingSenderForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('order_shipping_sender[%s]');
