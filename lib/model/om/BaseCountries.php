...
abstract class BaseCountries extends BaseObject  implements Persistent {
	...
	public function setShort($v)
	{
		...
		if ($this->short !== $v || $this->isNew()) {
			$this->short = $v;
			$this->modifiedColumns[] = CountriesPeer::SHORT;
		}
	...
	public function setCurrency($v)
	{
		...
		if ($this->currency !== $v || $this->isNew()) {
			$this->currency = $v;
			$this->modifiedColumns[] = CountriesPeer::CURRENCY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->currency = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CountriesPeer::NUM_COLUMNS - CountriesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CountriesPeer::SHORT)) $criteria->add(CountriesPeer::SHORT, $this->short);
		if ($this->isColumnModified(CountriesPeer::CURRENCY)) $criteria->add(CountriesPeer::CURRENCY, $this->currency);
	 ...
	 * Otherwise if this Countries has previously been saved, it will retrieve
	 * related OrderShippings from storage. If this Countries is new, it will return
		...
		if ($this->collOrderShippings === null) {
			if ($this->isNew()) {
			   $this->collOrderShippings = array();
				...
				$criteria->add(OrderShippingPeer::COUNTRY_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Countries has previously been saved, it will retrieve
	 * related ShippingTypess from storage. If this Countries is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collShippingTypess === null) {
			if ($this->isNew()) {
			   $this->collShippingTypess = array();
				...
				$criteria->add(ShippingTypesPeer::COUNTRY_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Countries has previously been saved, it will retrieve
	 * related ShippingOptionss from storage. If this Countries is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collShippingOptionss === null) {
			if ($this->isNew()) {
			   $this->collShippingOptionss = array();
				...
				$criteria->add(ShippingOptionsPeer::COUNTRY_ID, $this->id);
	 ...
	 * actually need in Countries.
	 */
	public function getShippingOptionssJoinCourier($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CountriesPeer::DATABASE_NAME);
		}
		...
		if ($this->collShippingOptionss === null) {
			if ($this->isNew()) {
				...
				$this->collShippingOptionss = ShippingOptionsPeer::doSelectJoinCourier($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Countries has previously been saved, it will retrieve
	 * related ZonesCountriess from storage. If this Countries is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collZonesCountriess === null) {
			if ($this->isNew()) {
			   $this->collZonesCountriess = array();
				...
				$criteria->add(ZonesCountriesPeer::COUNTRY_ID, $this->id);
	 ...
	 * actually need in Countries.
	 */
	public function getZonesCountriessJoinZones($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CountriesPeer::DATABASE_NAME);
		}
		...
		if ($this->collZonesCountriess === null) {
			if ($this->isNew()) {
				...
				$this->collZonesCountriess = ZonesCountriesPeer::doSelectJoinZones($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
