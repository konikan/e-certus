...
/**
 * Base class that represents a row from the 'user_sender' table.
 *
 * 
 *
 ...
 */
abstract class BaseUserSender extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseUserSender object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     UserSender The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserSenderPeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = UserSenderPeer::USER_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserSenderPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserSenderPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setIsCompany($v)
	{
		...
		if ($this->is_company !== $v || $this->isNew()) {
			$this->is_company = $v;
			$this->modifiedColumns[] = UserSenderPeer::IS_COMPANY;
		}
	...
	public function setIsDefault($v)
	{
		...
		if ($this->is_default !== $v || $this->isNew()) {
			$this->is_default = $v;
			$this->modifiedColumns[] = UserSenderPeer::IS_DEFAULT;
		}
	...
	public function setSenderName($v)
	{
		...
		if ($this->sender_name !== $v) {
			$this->sender_name = $v;
			$this->modifiedColumns[] = UserSenderPeer::SENDER_NAME;
		}
	...
	public function setContactName($v)
	{
		...
		if ($this->contact_name !== $v) {
			$this->contact_name = $v;
			$this->modifiedColumns[] = UserSenderPeer::CONTACT_NAME;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = UserSenderPeer::NAME;
		}
	...
	public function setSurname($v)
	{
		...
		if ($this->surname !== $v) {
			$this->surname = $v;
			$this->modifiedColumns[] = UserSenderPeer::SURNAME;
		}
	...
	public function setPostcode($v)
	{
		...
		if ($this->postcode !== $v) {
			$this->postcode = $v;
			$this->modifiedColumns[] = UserSenderPeer::POSTCODE;
		}
	...
	public function setCity($v)
	{
		...
		if ($this->city !== $v) {
			$this->city = $v;
			$this->modifiedColumns[] = UserSenderPeer::CITY;
		}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v || $this->isNew()) {
			$this->country = $v;
			$this->modifiedColumns[] = UserSenderPeer::COUNTRY;
		}
	...
	public function setAddress($v)
	{
		...
		if ($this->address !== $v) {
			$this->address = $v;
			$this->modifiedColumns[] = UserSenderPeer::ADDRESS;
		}
	...
	public function setStreet($v)
	{
		...
		if ($this->street !== $v) {
			$this->street = $v;
			$this->modifiedColumns[] = UserSenderPeer::STREET;
		}
	...
	public function setStreetNr($v)
	{
		...
		if ($this->street_nr !== $v) {
			$this->street_nr = $v;
			$this->modifiedColumns[] = UserSenderPeer::STREET_NR;
		}
	...
	public function setLocalNr($v)
	{
		...
		if ($this->local_nr !== $v) {
			$this->local_nr = $v;
			$this->modifiedColumns[] = UserSenderPeer::LOCAL_NR;
		}
	...
	public function setTel($v)
	{
		...
		if ($this->tel !== $v) {
			$this->tel = $v;
			$this->modifiedColumns[] = UserSenderPeer::TEL;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = UserSenderPeer::EMAIL;
		}
	...
	public function setCompanyName($v)
	{
		...
		if ($this->company_name !== $v) {
			$this->company_name = $v;
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_NAME;
		}
	...
	public function setCompanyNip($v)
	{
		...
		if ($this->company_nip !== $v) {
			$this->company_nip = $v;
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_NIP;
		}
	...
	public function setCompanyPostCode($v)
	{
		...
		if ($this->company_post_code !== $v) {
			...
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_POST_CODE;
		}
	...
	public function setCompanyCity($v)
	{
		...
		if ($this->company_city !== $v) {
			$this->company_city = $v;
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_CITY;
		}
	...
	public function setCompanyStreet($v)
	{
		...
		if ($this->company_street !== $v) {
			...
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_STREET;
		}
	...
	public function setCompanyHomeNr($v)
	{
		...
		if ($this->company_home_nr !== $v) {
			...
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_HOME_NR;
		}
	...
	public function setCompanyLocalNr($v)
	{
		...
		if ($this->company_local_nr !== $v) {
			...
			$this->modifiedColumns[] = UserSenderPeer::COMPANY_LOCAL_NR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sender_name = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->contact_name = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->name = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->surname = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->postcode = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			...
			$this->street = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->street_nr = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->local_nr = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->tel = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			...
			return $startcol + 26; // 26 = UserSenderPeer::NUM_COLUMNS - UserSenderPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UserSender object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UserSenderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseUserSender:delete:pre') as $callable)
			{
			...
			if ($ret) {
				UserSenderPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUserSender:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseUserSender:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(UserSenderPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(UserSenderPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUserSender:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				UserSenderPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UserSenderPeer::doInsert($this, $con);
					...
					$affectedRows += UserSenderPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UserSenderPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UserSenderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UserSenderPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			...
			$keys[6] => $this->getSenderName(),
			$keys[7] => $this->getContactName(),
			$keys[8] => $this->getName(),
			...
			$keys[14] => $this->getStreet(),
			$keys[15] => $this->getStreetNr(),
			$keys[16] => $this->getLocalNr(),
			$keys[17] => $this->getTel(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setSenderName($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setContactName($arr[$keys[7]]);
		...
		if (array_key_exists($keys[14], $arr)) $this->setStreet($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setStreetNr($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setLocalNr($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setTel($arr[$keys[17]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserSenderPeer::ID)) $criteria->add(UserSenderPeer::ID, $this->id);
		if ($this->isColumnModified(UserSenderPeer::USER_ID)) $criteria->add(UserSenderPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(UserSenderPeer::CREATED_AT)) $criteria->add(UserSenderPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(UserSenderPeer::UPDATED_AT)) $criteria->add(UserSenderPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(UserSenderPeer::IS_COMPANY)) $criteria->add(UserSenderPeer::IS_COMPANY, $this->is_company);
		if ($this->isColumnModified(UserSenderPeer::IS_DEFAULT)) $criteria->add(UserSenderPeer::IS_DEFAULT, $this->is_default);
		if ($this->isColumnModified(UserSenderPeer::SENDER_NAME)) $criteria->add(UserSenderPeer::SENDER_NAME, $this->sender_name);
		if ($this->isColumnModified(UserSenderPeer::CONTACT_NAME)) $criteria->add(UserSenderPeer::CONTACT_NAME, $this->contact_name);
		if ($this->isColumnModified(UserSenderPeer::NAME)) $criteria->add(UserSenderPeer::NAME, $this->name);
		if ($this->isColumnModified(UserSenderPeer::SURNAME)) $criteria->add(UserSenderPeer::SURNAME, $this->surname);
		if ($this->isColumnModified(UserSenderPeer::POSTCODE)) $criteria->add(UserSenderPeer::POSTCODE, $this->postcode);
		if ($this->isColumnModified(UserSenderPeer::CITY)) $criteria->add(UserSenderPeer::CITY, $this->city);
		if ($this->isColumnModified(UserSenderPeer::COUNTRY)) $criteria->add(UserSenderPeer::COUNTRY, $this->country);
		if ($this->isColumnModified(UserSenderPeer::ADDRESS)) $criteria->add(UserSenderPeer::ADDRESS, $this->address);
		if ($this->isColumnModified(UserSenderPeer::STREET)) $criteria->add(UserSenderPeer::STREET, $this->street);
		if ($this->isColumnModified(UserSenderPeer::STREET_NR)) $criteria->add(UserSenderPeer::STREET_NR, $this->street_nr);
		if ($this->isColumnModified(UserSenderPeer::LOCAL_NR)) $criteria->add(UserSenderPeer::LOCAL_NR, $this->local_nr);
		if ($this->isColumnModified(UserSenderPeer::TEL)) $criteria->add(UserSenderPeer::TEL, $this->tel);
		if ($this->isColumnModified(UserSenderPeer::EMAIL)) $criteria->add(UserSenderPeer::EMAIL, $this->email);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_NAME)) $criteria->add(UserSenderPeer::COMPANY_NAME, $this->company_name);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_NIP)) $criteria->add(UserSenderPeer::COMPANY_NIP, $this->company_nip);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_POST_CODE)) $criteria->add(UserSenderPeer::COMPANY_POST_CODE, $this->company_post_code);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_CITY)) $criteria->add(UserSenderPeer::COMPANY_CITY, $this->company_city);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_STREET)) $criteria->add(UserSenderPeer::COMPANY_STREET, $this->company_street);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_HOME_NR)) $criteria->add(UserSenderPeer::COMPANY_HOME_NR, $this->company_home_nr);
		if ($this->isColumnModified(UserSenderPeer::COMPANY_LOCAL_NR)) $criteria->add(UserSenderPeer::COMPANY_LOCAL_NR, $this->company_local_nr);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UserSenderPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UserSender (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UserSender Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UserSenderPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UserSenderPeer();
		}
		return self::$peer;
	}
	...
	public function getUsers(PropelPDO $con = null)
	{
		if ($this->aUsers === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsers->addUserSenders($this);
			 */
		}
		return $this->aUsers;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseUserSender:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseUserSender::%s', $method));
	  }
