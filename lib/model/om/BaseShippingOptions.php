...
/**
 * Base class that represents a row from the 'shipping_options' table.
 *
 * 
 *
 ...
 */
abstract class BaseShippingOptions extends BaseObject  implements Persistent {
	...
	const PEER = 'ShippingOptionsPeer';
	...
	/**
	 * Initializes internal state of BaseShippingOptions object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ShippingOptions The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::ID;
		}
	...
	public function setCourierId($v)
	{
		...
		if ($this->courier_id !== $v) {
			$this->courier_id = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::COURIER_ID;
		}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::CODE;
		}
	...
	public function setShortName($v)
	{
		...
		if ($this->short_name !== $v) {
			$this->short_name = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::SHORT_NAME;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::NAME;
		}
	...
	public function setServiceId($v)
	{
		...
		if ($this->service_id !== $v) {
			$this->service_id = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::SERVICE_ID;
		}
	...
	public function setIsPublicAccess($v)
	{
		...
		if ($this->is_public_access !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::IS_PUBLIC_ACCESS;
		}
	...
	public function setIsAvailable($v)
	{
		...
		if ($this->is_available !== $v || $this->isNew()) {
			$this->is_available = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::IS_AVAILABLE;
		}
	...
	public function setShowInCalculate($v)
	{
		...
		if ($this->show_in_calculate !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::SHOW_IN_CALCULATE;
		}
	...
	public function setShowInTariff($v)
	{
		...
		if ($this->show_in_tariff !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::SHOW_IN_TARIFF;
		}
	...
	public function setCashOnDelivery($v)
	{
		...
		if ($this->cash_on_delivery !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::CASH_ON_DELIVERY;
		}
	...
	public function setCommission($v)
	{
		...
		if ($this->commission !== $v) {
			$this->commission = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::COMMISSION;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::PRICE;
		}
	...
	public function setInsurance($v)
	{
		...
		if ($this->insurance !== $v || $this->isNew()) {
			$this->insurance = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::INSURANCE;
		}
	...
	public function setFreeInsuranceLimit($v)
	{
		...
		if ($this->free_insurance_limit !== $v) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::FREE_INSURANCE_LIMIT;
		}
	...
	public function setAdditionalAmount($v)
	{
		...
		if ($this->additional_amount !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::ADDITIONAL_AMOUNT;
		}
	...
	public function setNotice($v)
	{
		...
		if ($this->notice !== $v) {
			$this->notice = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::NOTICE;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::TYPE;
		}
	...
	public function setIsInternational($v)
	{
		...
		if ($this->is_international !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ShippingOptionsPeer::IS_INTERNATIONAL;
		}
	...
	public function setCountryId($v)
	{
		...
		if ($this->country_id !== $v) {
			$this->country_id = $v;
			$this->modifiedColumns[] = ShippingOptionsPeer::COUNTRY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_international = ($row[$startcol + 18] !== null) ? (boolean) $row[$startcol + 18] : null;
			...
			return $startcol + 20; // 20 = ShippingOptionsPeer::NUM_COLUMNS - ShippingOptionsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ShippingOptions object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ShippingOptionsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseShippingOptions:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ShippingOptionsPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseShippingOptions:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseShippingOptions:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseShippingOptions:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ShippingOptionsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ShippingOptionsPeer::doInsert($this, $con);
					...
					$affectedRows += ShippingOptionsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ShippingOptionsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ShippingOptionsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ShippingOptionsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			...
			$keys[18] => $this->getIsInternational(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[18], $arr)) $this->setIsInternational($arr[$keys[18]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ShippingOptionsPeer::ID)) $criteria->add(ShippingOptionsPeer::ID, $this->id);
		if ($this->isColumnModified(ShippingOptionsPeer::COURIER_ID)) $criteria->add(ShippingOptionsPeer::COURIER_ID, $this->courier_id);
		if ($this->isColumnModified(ShippingOptionsPeer::CODE)) $criteria->add(ShippingOptionsPeer::CODE, $this->code);
		if ($this->isColumnModified(ShippingOptionsPeer::SHORT_NAME)) $criteria->add(ShippingOptionsPeer::SHORT_NAME, $this->short_name);
		if ($this->isColumnModified(ShippingOptionsPeer::NAME)) $criteria->add(ShippingOptionsPeer::NAME, $this->name);
		if ($this->isColumnModified(ShippingOptionsPeer::SERVICE_ID)) $criteria->add(ShippingOptionsPeer::SERVICE_ID, $this->service_id);
		if ($this->isColumnModified(ShippingOptionsPeer::IS_PUBLIC_ACCESS)) $criteria->add(ShippingOptionsPeer::IS_PUBLIC_ACCESS, $this->is_public_access);
		if ($this->isColumnModified(ShippingOptionsPeer::IS_AVAILABLE)) $criteria->add(ShippingOptionsPeer::IS_AVAILABLE, $this->is_available);
		if ($this->isColumnModified(ShippingOptionsPeer::SHOW_IN_CALCULATE)) $criteria->add(ShippingOptionsPeer::SHOW_IN_CALCULATE, $this->show_in_calculate);
		if ($this->isColumnModified(ShippingOptionsPeer::SHOW_IN_TARIFF)) $criteria->add(ShippingOptionsPeer::SHOW_IN_TARIFF, $this->show_in_tariff);
		if ($this->isColumnModified(ShippingOptionsPeer::CASH_ON_DELIVERY)) $criteria->add(ShippingOptionsPeer::CASH_ON_DELIVERY, $this->cash_on_delivery);
		if ($this->isColumnModified(ShippingOptionsPeer::COMMISSION)) $criteria->add(ShippingOptionsPeer::COMMISSION, $this->commission);
		if ($this->isColumnModified(ShippingOptionsPeer::PRICE)) $criteria->add(ShippingOptionsPeer::PRICE, $this->price);
		if ($this->isColumnModified(ShippingOptionsPeer::INSURANCE)) $criteria->add(ShippingOptionsPeer::INSURANCE, $this->insurance);
		if ($this->isColumnModified(ShippingOptionsPeer::FREE_INSURANCE_LIMIT)) $criteria->add(ShippingOptionsPeer::FREE_INSURANCE_LIMIT, $this->free_insurance_limit);
		if ($this->isColumnModified(ShippingOptionsPeer::ADDITIONAL_AMOUNT)) $criteria->add(ShippingOptionsPeer::ADDITIONAL_AMOUNT, $this->additional_amount);
		if ($this->isColumnModified(ShippingOptionsPeer::NOTICE)) $criteria->add(ShippingOptionsPeer::NOTICE, $this->notice);
		if ($this->isColumnModified(ShippingOptionsPeer::TYPE)) $criteria->add(ShippingOptionsPeer::TYPE, $this->type);
		if ($this->isColumnModified(ShippingOptionsPeer::IS_INTERNATIONAL)) $criteria->add(ShippingOptionsPeer::IS_INTERNATIONAL, $this->is_international);
		if ($this->isColumnModified(ShippingOptionsPeer::COUNTRY_ID)) $criteria->add(ShippingOptionsPeer::COUNTRY_ID, $this->country_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ShippingOptionsPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ShippingOptions (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ShippingOptions Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ShippingOptionsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ShippingOptionsPeer();
		}
		return self::$peer;
	}
	...
	public function getCourier(PropelPDO $con = null)
	{
		if ($this->aCourier === null && ($this->courier_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCourier->addShippingOptionss($this);
			 */
		}
	...
	public function getCountries(PropelPDO $con = null)
	{
		if ($this->aCountries === null && ($this->country_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCountries->addShippingOptionss($this);
			 */
		}
	 ...
	 * Otherwise if this ShippingOptions has previously been saved, it will retrieve
	 * related OrderShippingOptionss from storage. If this ShippingOptions is new, it will return
		...
		if ($this->collOrderShippingOptionss === null) {
			if ($this->isNew()) {
			   $this->collOrderShippingOptionss = array();
				...
				$criteria->add(OrderShippingOptionsPeer::OPTION_ID, $this->id);
	 ...
	 * Otherwise if this ShippingOptions is new, it will return
	 * an empty collection; or if this ShippingOptions has previously
	 * been saved, it will retrieve related OrderShippingOptionss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ShippingOptions.
	 */
	public function getOrderShippingOptionssJoinOrderShipping($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ShippingOptionsPeer::DATABASE_NAME);
		}
		...
		if ($this->collOrderShippingOptionss === null) {
			if ($this->isNew()) {
				...
				$this->collOrderShippingOptionss = OrderShippingOptionsPeer::doSelectJoinOrderShipping($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseShippingOptions:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseShippingOptions::%s', $method));
	  }
