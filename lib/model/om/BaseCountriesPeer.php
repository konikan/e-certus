...
abstract class BaseCountriesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Countries';
	...
	const SHORT = 'countries.SHORT';

	/** the column name for the CURRENCY field */
	const CURRENCY = 'countries.CURRENCY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Short', 'Currency', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'short', 'currency', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SHORT, self::CURRENCY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'short', 'currency', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Short' => 2, 'Currency' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'short' => 2, 'currency' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SHORT => 2, self::CURRENCY => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'short' => 2, 'currency' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountriesPeer::SHORT);
		$criteria->addSelectColumn(CountriesPeer::CURRENCY);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCountriesPeer', $criteria, $con);
		}
	 ...
	 */
	public static function addInstanceToPool(Countries $obj, $key = null)
	{
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in ShippingOptionsPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
		return $withPrefix ? CountriesPeer::CLASS_DEFAULT : CountriesPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCountriesPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCountriesPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCountriesPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCountriesPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCountriesPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCountriesPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCountriesPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCountriesPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CountriesPeer::doOnDeleteCascade(new Criteria(CountriesPeer::DATABASE_NAME), $con);
			CountriesPeer::doOnDeleteSetNull(new Criteria(CountriesPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CountriesPeer::doOnDeleteCascade($criteria, $con);
			CountriesPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ShippingTypesPeer::COUNTRY_ID, $obj->getId());
			$affectedRows += ShippingTypesPeer::doDelete($criteria, $con);

			// delete related ShippingOptions objects
			$criteria = new Criteria(ShippingOptionsPeer::DATABASE_NAME);
			
			$criteria->add(ShippingOptionsPeer::COUNTRY_ID, $obj->getId());
			$affectedRows += ShippingOptionsPeer::doDelete($criteria, $con);

			// delete related ZonesCountries objects
			$criteria = new Criteria(ZonesCountriesPeer::DATABASE_NAME);
			
			$criteria->add(ZonesCountriesPeer::COUNTRY_ID, $obj->getId());
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(OrderShippingPeer::COUNTRY_ID, $obj->getId());
			$updateValues->add(OrderShippingPeer::COUNTRY_ID, null);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCountriesPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
