...
abstract class BaseQuestions extends BaseObject  implements Persistent {
	...
	public function setQuestion($v)
	{
		...
		if ($this->question !== $v) {
			$this->question = $v;
			$this->modifiedColumns[] = QuestionsPeer::QUESTION;
		}
	...
	public function setReply($v)
	{
		...
		if ($this->reply !== $v) {
			$this->reply = $v;
			$this->modifiedColumns[] = QuestionsPeer::REPLY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->reply = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = QuestionsPeer::NUM_COLUMNS - QuestionsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(QuestionsPeer::CREATED_AT))
				{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setReply($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuestionsPeer::QUESTION)) $criteria->add(QuestionsPeer::QUESTION, $this->question);
		if ($this->isColumnModified(QuestionsPeer::REPLY)) $criteria->add(QuestionsPeer::REPLY, $this->reply);
