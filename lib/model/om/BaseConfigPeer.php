...
abstract class BaseConfigPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CreatedAt', 'UpdatedAt', 'Name', 'Value', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('createdAt', 'updatedAt', 'name', 'value', ),
		BasePeer::TYPE_COLNAME => array (self::CREATED_AT, self::UPDATED_AT, self::NAME, self::VALUE, ),
		BasePeer::TYPE_FIELDNAME => array ('created_at', 'updated_at', 'name', 'value', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CreatedAt' => 0, 'UpdatedAt' => 1, 'Name' => 2, 'Value' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('createdAt' => 0, 'updatedAt' => 1, 'name' => 2, 'value' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CREATED_AT => 0, self::UPDATED_AT => 1, self::NAME => 2, self::VALUE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('created_at' => 0, 'updated_at' => 1, 'name' => 2, 'value' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ConfigPeer::NAME);
			$selectCriteria->add(ConfigPeer::NAME, $criteria->remove(ConfigPeer::NAME), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ConfigPeer::NAME, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ConfigPeer::NAME, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ConfigPeer::DATABASE_NAME);
			$criteria->add(ConfigPeer::NAME, $pks, Criteria::IN);
