...
/**
 * This class defines the structure of the 'user_sender' table.
 *
 *
 ...
 */
class UserSenderTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.UserSenderTableMap';
	...
	{
	  // attributes
		$this->setName('user_sender');
		$this->setPhpName('UserSender');
		$this->setClassname('UserSender');
