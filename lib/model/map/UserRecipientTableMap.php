...
/**
 * This class defines the structure of the 'user_recipient' table.
 *
 *
 ...
 */
class UserRecipientTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.UserRecipientTableMap';
	...
	{
	  // attributes
		$this->setName('user_recipient');
		$this->setPhpName('UserRecipient');
		$this->setClassname('UserRecipient');
		...
		$this->addColumn('IS_COMPANY', 'IsCompany', 'BOOLEAN', false, null, false);
