...
/**
 * This class defines the structure of the 'zones_services' table.
 *
 *
 ...
 */
class ZonesServicesTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ZonesServicesTableMap';
	...
	{
	  // attributes
		$this->setName('zones_services');
		$this->setPhpName('ZonesServices');
		$this->setClassname('ZonesServices');
    ...
    $this->addRelation('OrderShippingZonesServices', 'OrderShippingZonesServices', RelationMap::ONE_TO_MANY, array('id' => 'service_id', ), null, null);
	} // buildRelations()
